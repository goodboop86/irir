    ...
    def async_trace(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            try:
                ...
                Utils.logger.info(f"Async Method '{class_name}.{method_name}' completed successfully.")
                return result
            except Exception as e:
                Utils.logger.error(f"Async Method '{class_name}.{method_name}' failed with error: {e}")
                raise
        return wrapper
        ...
        if inspect.iscoroutinefunction(func):
            ...
            def sync_wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    Utils.logger.info(f"Method '{class_name}.{method_name}' completed successfully.")
                    return result
                except Exception as e:
                    Utils.logger.error(f"Method '{class_name}.{method_name}' failed with error: {e}")
                    raise
            return sync_wrapper
